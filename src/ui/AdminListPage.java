...
import dao.DogDAO;
import dialog.DogRegiDialog;
import dto.DogDTO;
import graphics.RoundPanel;

public class AdminListPage {

	protected JPanel adminListPanel;
	...
	public AdminListPage() {
		...
		adminListPanel.setBackground(new Color(236, 229, 199));
		...
		adminListPanel.add(scroll);
		
		List<DogDTO> list = dogDAO.listDogAdmin();
...
//	        JLabel desc2 = new JLabel("종 : " + dog.getDogSpe());
			...
			dog.getDetailBtn().addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					DogRegiDialog dogRegiDial = new DogRegiDialog();
					dogRegiDial.setVisible(true);
				}
			});
		}
