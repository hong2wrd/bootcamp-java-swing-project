...
public class IdDuplicateDialog extends JFrame implements ActionListener {
...
//		라운드 패널
		...
		/* 메시지 */
		message = new JLabel("중복된 아이디를 발견했습니다!");
		message2 = new JLabel("아이디를 확인해주세요 :(");
	...
	public static void main(String[] args) {
		IdDuplicateDialog ld = new IdDuplicateDialog();
		ld.setVisible(true);
	}
