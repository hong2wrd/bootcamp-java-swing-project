...
public class LogInFailedPassDialog extends JFrame implements ActionListener {
...
//		라운드 패널
	...
	public static void main(String[] args) {
		LogInFailedPassDialog ld = new LogInFailedPassDialog();
		ld.setVisible(true);
	}
