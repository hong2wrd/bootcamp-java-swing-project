...
public class DataRequestDialog extends JFrame implements ActionListener {
...
//		라운드 패널
		...
		message2 = new JLabel("정보를 확인해주세요! :(");
	...
	public static void main(String[] args) {
		DataRequestDialog ld = new DataRequestDialog();
		ld.setVisible(true);
	}
